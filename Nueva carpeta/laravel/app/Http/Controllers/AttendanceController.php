...
class AttendanceController extends Controller
{
    ...
    public function checkInOut(Request $request)
    {
        ...
        try {
            ...
            // $exist = Employee::where('last_name_1', $request->last_name_1)->where('first_name', $request->first_name)->exists();
            ...
            // $employee = Employee::where('last_name_1', $request->last_name_1)->where('first_name', $request->first_name)->first();
            ...
            if ($last_check) {
                ...
                if ($difference_last_check < 1) {
                    return response()->json([
                        "status" => "ok",
                        "message" => "Advertencia, acabas de realizar un registro recientemente"
                    ], 200);
                }
